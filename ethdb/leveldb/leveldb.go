...
func (db *Database) Put(key []byte, value []byte) error {
	fmt.Printf("Put, key: %X, value: %d", key, unsafe.Sizeof(value))
...
func (db *Database) NewIterator(prefix []byte, start []byte) ethdb.Iterator {
	fmt.Printf("NewIterator, prefix: %X\n", prefix, "start: %X\n", start)
...
func (b *batch) Put(key, value []byte) error {
	fmt.Printf("Batch %X, Put, key: %X\n value: %d", b, key, unsafe.Sizeof(value))
	b.b.Put(key, value)
...
func (b *batch) Delete(key []byte) error {
	fmt.Printf("Batch %X, Delete, key: %X\n", b, key)
	b.b.Delete(key)
	b.size += len(key)
	return nil
}
